                          ...
                          <TableRow key={data.id}>
                            ...
                            <TableCell>
                              <CardMedia
                                ...
                                component="img"
                                height="100"
                                image={`${process.env.NEXT_PUBLIC_URL_MEDIA}/${process.env.NEXT_PUBLIC_URL_FOLDER_MAIN_S3}/${process.env.NEXT_PUBLIC_URL_FOLDER_SSA_S3}/${folderModule}/${data.imagenObservacion}`}
                            ...
                            <TableCell>
                              <CardMedia
                                ...
                                component="img"
                                height="100"
                                image={`${process.env.NEXT_PUBLIC_URL_MEDIA}/${process.env.NEXT_PUBLIC_URL_FOLDER_MAIN_S3}/${process.env.NEXT_PUBLIC_URL_FOLDER_SSA_S3}/${folderModule}/${data.imagenObservacionCierre}`}
