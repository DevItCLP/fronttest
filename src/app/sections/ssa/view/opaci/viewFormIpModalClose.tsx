...
export const CloseObservacion: React.FC<CloseObservacionProps<any>> = ({
  open,
  onClose,
  onSubmit,
  register,
          ...
          <Grid container spacing={4}>
              ...
              <Table size="small">
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Typography>{watch("descripcionObservacion")}</Typography>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ textAlign: "left", width: 150 }}>
                    ...
                    <TableCell>
                      <Typography>{watch("accionObservacion")}</Typography>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ textAlign: "left", width: 150 }}>
                    ...
                    <TableCell>
                      <Typography>{watch("fechaObservacion")}</Typography>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ textAlign: "left", width: 150 }}>
                    ...
                    <TableCell>
                      <Typography>{watch("usuarioControl")}</Typography>
                    </TableCell>
                  </TableRow>
                    ...
                    <TableCell colSpan={2}>
                      <Grid item xs={12} sm={6} md={6}>
                        <CardMedia
                          ...
                          }/inspecciones-planificadas/${watch("imageObservacion")}`}
                          style={{ objectFit: "contain" }}
                          alt={watch("imageObservacion")}
                        />
                      </Grid>
                    </TableCell>
                  </TableRow>
            ...
            <Grid item xs={12} md={6} sx={{ display: "grid", alignItems: "center" }}>
              ...
              <Grid container spacing={3} justifyContent={"center"}>
                {watch("imagenAccionRealizadaCierre") &&
                  watch("imagenAccionRealizadaCierre")
                    .split(", ")
