...
export const ViewAddArea: React.FC<UserModalProps<any>> = ({
  open,
  onClose,
  onSubmit,
  estadosave,
      ...
      <Dialog open={open} onClose={onClose} component="form" onSubmit={onSubmit}>
        <DialogTitle sx={{ m: 0, p: 2 }} id="customized-dialog-title">
          ...
          <Typography variant="button" sx={{ fontWeight: "bold", color: (theme) => theme.palette.grey[500] }}>
            {estadosave == 1 ? "      Nueva Área" : "      Actualizar Área"}
          </Typography>
        </DialogTitle>
        <IconButton
          aria-label="close"
        ...
        <DialogContent dividers>
          <Grid container spacing={2}>
            ...
            <FormControlLabel
                ...
                control={<Switch {...register("statusArea")} name="statusArea" defaultChecked />}
              />
            </Grid>
